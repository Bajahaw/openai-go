...
type ChatCompletionChunkChoiceDelta struct {
	...
	// The reasonings of the chunk message.
	Reasoning string `json:"reasoning" api:"nullable"`
	// The reasonings of the chunk message. (github copilot api)
	ReasoningText string `json:"reasoning_text" api:"nullable"`
	// The reasonings of the chunk message. (fireworks and similar providers)
...
type ChatCompletionMessage struct {
	...
	// The reasonings of the message.
	Reasoning string `json:"reasoning" api:"required"`
	// The reasoning text of the message. (copilot api)
	ReasoningText string `json:"reasoning_text" api:"required"`
	// The reasonings of the message. (fireworks and similar providers)
	ReasoningContent string `json:"reasoning_content" api:"required"`
	// The refusal message generated by the model.
	Refusal string `json:"refusal" api:"required"`
	// The role of the author of this message.
	Role constant.Assistant `json:"role" api:"required"`
